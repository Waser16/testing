...
"""
В данной практической работе нужно использовать первые три подхода. 
Эти подходы доступны "из коробки" (не нужно устанавливать дополнительные пакеты).

Следует выбрать любой алгоритм: например, алгоритм сортировки, 
рассчёт значения функции (квадратичной, тригонометрической).
